...
BENCHMARK(BM_PSQLUpdateLinksWithTransaction)->Arg(1000)->Setup(internal::SetupPSQL)->Teardown(internal::TeardownPSQL);
BENCHMARK(BM_DoubletsUpdateLinksRAM)->Arg(1000);
BENCHMARK(BM_DoubletsUpdateLinksFile)->Arg(1000)->Setup(internal::SetupDoublets)->Teardown(internal::TeardownDoublets);
