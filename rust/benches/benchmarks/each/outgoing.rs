...
pub fn each_outgoing(c: &mut Criterion) -> Result<(), Box<dyn Error>> {
        ...
        benchmark! {
            ...
            "PSQL_NonTransaction",
            {
                for index in 1..=1_000 {
                    client.each_by([any, index, any], handler);
                }
    ...
    }
    {
        ...
        benchmark! {
            ...
            {
                for index in 1..=1_000 {
                    transaction.each_by([any, index, any], handler);
                }
                for index in 1_001..=2_000 {
                    transaction.each_by([any, index, any], handler);
                }
    ...
    }
    {
        ...
        benchmark! {
            ...
            {
                for index in 1..=1_000 {
                    links.each_by([any, index, any], handler);
                }
                for index in 1_001..=2_000 {
                    links.each_by([any, index, any], handler);
                }
