//! # PostgreSQL Each Outgoing Benchmark
//!
//! This benchmark measures the performance of querying links by source in PostgreSQL.
//!
//! ## Implementation
//!
//! SQL query:
//! ```sql
//! SELECT id, source, target FROM links WHERE source = $1
//! ```
//!
//! - Source column index lookup
...
/// Runs the each_outgoing benchmark on a PostgreSQL backend.
...
/// Creates benchmark for PostgreSQL backends on querying links by source.
